...
GRAPHICS_FILES = {
    ...
    "bsymbol_abyss": "DATA/event/bsymbol_abyss_anm.bin",
    "bsymbol_agunhy": "DATA/event/bsymbol_agunhy_anm.bin",
    "bsymbol_azort": "DATA/event/bsymbol_azort_anm.bin",
    "bsymbol_balk": "DATA/event/bsymbol_balk_anm.bin",
    "bsymbol_carion": "DATA/event/bsymbol_carion_anm.bin",
    "bsymbol_dawman": "DATA/event/bsymbol_dawman_anm.bin",
    "bsymbol_hyudol": "DATA/event/bsymbol_hyudol_anm.bin",
    "bsymbol_javil": "DATA/event/bsymbol_javil_anm.bin",
